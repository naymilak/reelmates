...
**Movie tracking web app** — search (TMDB), watchlist, watched titles with ratings, public **@handle** profiles (`/u/handle`).
...
**ReelMates** — spletna aplikacija za sledenje filmom: iskanje (TMDB), osebni watchlist, ogledani naslovi z oceno, javni profili prek **@handle** (`/u/handle`). Uporabniški vmesnik je v **angleščini**.
